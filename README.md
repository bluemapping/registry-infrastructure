...
registry infrastructure décrit par le code un aspect de l'infrastructure à provisionner pour bluemapping.
...
- [Github Actions](https://docs.github.com/en/actions) est l'outil d'intégration et de déploiement continu intégré à GitHub
    - L'historique des déploiements est disponible [sous l'onglet Actions](https://github.com/bluemapping/registry-infrastructure/actions/)
- Secrets du dépôt :
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `bluemapping.registry.infrastructure`
...
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    - Organisation : [bluemapping](https://app.terraform.io/app/bluemapping/workspaces)
    - Workspaces : `registry`
        - [registry](https://app.terraform.io/app/bluemapping/workspaces/registry)
    - Variables
